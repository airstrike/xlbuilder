...
class Ribbon(BaseElement, customUI14base.CT_Ribbon):
    ...
    def __init__(self, startFromScratch=None, qat=None, tabs=None, contextualTabs=None, **kwargs):
        super(Ribbon, self).__init__(startFromScratch, qat, tabs, contextualTabs, **kwargs)
...
class TabsMixin(BaseElement):
    ...
    def get_tab(self, id):
        ...
        raise IndexError(f'Tab with id "{_.id}" does not exist')


class Tabs(TabsMixin, customUI14base.CT_Tabs):
    name = 'tabs'


class TabSet(TabsMixin, customUI14base.CT_TabSet):
    name = 'tabSet'
...
class Group(BaseElement, customUI14base.CT_Group):
    name = 'group'
